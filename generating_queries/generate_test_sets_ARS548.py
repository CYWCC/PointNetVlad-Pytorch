...
def construct_query_and_database_sets(base_path, seq_forders, querysubmaps_file, databasesubmaps_file, pos_distence, query_posefile, database_posefile,save_path):
    ...
    output_to_file(database_sets, save_path + 'evaluation_database_1seq.pickle')
    output_to_file(test_sets, save_path + 'evaluation_query_1seq_'+ str(pos_distence) +'m.pickle')
...
if __name__ == '__main__':
    ...
    base_path = '/home/cyw/CYW/Datasets/ARS548'
    query_posefile = "query_submaps_poses.txt"
    database_posefile = "database_submaps_poses.txt"
    querysubmaps_file = "/query_submaps_bin/"
    databasesubmaps_file = "/database_submaps_bin/"
    save_path = "./ARS548_tuples/"
    pos_distence = 1
