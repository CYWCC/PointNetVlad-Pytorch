...
def evaluate_model(model):
    ...
    for seq_set in tqdm(QUERY_SETS, desc='Computing query embeddings'):
        QUERY_VECTOR = get_latent_vectors(model, QUERY_SETS[seq_set])
...
if __name__ == "__main__":
    ...
    cfg.EVAL_DATABASE_FILE = 'generating_queries/data_split/evaluation_database.pickle'
    cfg.EVAL_QUERY_FILE = 'generating_queries/data_split/evaluation_query_3m.pickle'

    cfg.LOG_DIR = 'log/'
    cfg.OUTPUT_FILE = cfg.RESULTS_FOLDER + '1424'
    cfg.MODEL_FILENAME = "best_checkpoint.pth.tar"
    cfg.MODEL_FILENAME = '1424/best_checkpoint.pth.tar'
